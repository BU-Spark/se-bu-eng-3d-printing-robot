                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Box sx={{ display: "flex", justifyContent: "center" }}>
                        <Chip
                          icon={
                            <StarIcon sx={{ color: "#FFD700 !important" }} />
                          }
                          label={row.rank}
                          size="small"
                          sx={{
                    ...
                    <TableCell align="center">
                      <Typography variant="body2">{row.lBend}</Typography>
                    </TableCell>
                    <TableCell align="center">
                      <Typography variant="body2">{row.lStretch}</Typography>
                    </TableCell>
                    <TableCell align="center">
                      <Typography variant="body2">{row.lRest}</Typography>
                    </TableCell>
                    <TableCell align="center">
                      <Typography variant="body2" fontWeight={500}>
                        {row.energyAbsorbed}
