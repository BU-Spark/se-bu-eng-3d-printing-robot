...
export default function ManageApprovalsPage() {
  ...
  const handleReconsider = (submission: any) => {
    ...
    const { rejectedDate, rejectedTimeAgo, reason, ...pendingSubmission } =
      submission;
      ...
      case 1:
        return (
          <CheckCircleOutlineIcon
            sx={{ fontSize: 64, color: "success.light" }}
          />
        );
      case 2:
        return (
          <CancelOutlinedIcon sx={{ fontSize: 64, color: "error.light" }} />
        );
      default:
    ...
    <Box sx={{ maxWidth: 1200, mx: "auto", p: { xs: 2, sm: 3, md: 4 } }}>
      ...
      >
        <Typography variant="body2">
          This page allows administrators to approve user access. Users must
          sign up through Clerk first, then can be granted submission privileges
          here.
        </Typography>
      </Alert>
            ...
            label={
              <Box
                sx={{
                  display: "flex",
                  alignItems: "center",
                  color: tabValue === 0 ? "#F57C00" : "inherit",
                }}
              >
                <AccessTimeIcon
                  sx={{
            ...
            label={
              <Box
                sx={{
                  display: "flex",
                  alignItems: "center",
                  color: tabValue === 2 ? "#CC0000" : "inherit",
                }}
              >
                <CancelOutlinedIcon
                  sx={{
      ...
      {currentSubmissions.length > 0 ? (
        ...
        >
          ...
          >
            There are currently no {getTabLabel(tabValue)} submissions in the
            system.
            {tabValue === 0 &&
              " New submissions will appear here when users request access."}
          </Typography>
        </Paper>
      )}
